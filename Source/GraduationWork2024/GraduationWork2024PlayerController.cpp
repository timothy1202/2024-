...
void AGraduationWork2024PlayerController::OnInputStarted()
{
	StopMovement();
}

// Triggered every frame when the input is held down
void AGraduationWork2024PlayerController::OnSetDestinationTriggered()
{
...
void AGraduationWork2024PlayerController::OnSetDestinationReleased()
{
...
// Triggered every frame when the input is held down
void AGraduationWork2024PlayerController::OnTouchTriggered()
{
	bIsTouch = true;
	OnSetDestinationTriggered();
}

void AGraduationWork2024PlayerController::OnTouchReleased()
{
	bIsTouch = false;
